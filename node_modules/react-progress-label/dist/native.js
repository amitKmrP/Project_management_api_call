...
var ProgressLabel = function ProgressLabel(_ref) {
  var _ref$components = _ref.components,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["components", "progress", "progressWidth", "progressColor", "trackWidth", "trackBorderWidth", "trackBorderColor", "cornersWidth", "fillColor", "trackColor", "startDegree", "size", "text", "textProps"]);
  ...
  return React.createElement(Svg, _extends({}, props, {
    ...
    fill: trackColor
  }), trackBorderWidth > 0 ? React.createElement(Circle, {
    cx: cx,
    cy: cy,
  ...
  }) : null, trackBorderWidth > 0 ? React.createElement(Circle, {
    cx: cx,
    cy: cy,
  ...
  }) : null, progress > 0 ? React.createElement(Path, {
    d: progressPath,
    style: progressStyle
  }) : null, progress > 0 ? React.createElement(Circle, {
    cx: s.x,
    cy: s.y,
    r: cornersWidth,
    fill: progressColor
    ...
    r: cornersWidth,
    fill: progressColor
  }) : null, text ? React.createElement(Text, textProps, text) : null);
};
...
var RNProgressLabel = function RNProgressLabel(props) {
  return React.createElement(ProgressLabel, _extends({
    components: {
      Svg: Svg,
      Path: Path,
      Circle: Circle,
